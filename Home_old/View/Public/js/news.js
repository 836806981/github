        ...
        $.AjaxPost(MODULE+"/getNewsList", {currentpage:currentpage_zcj, pagenum:pagenum_zcj,belong:belong}, function (backdata) {
            if (backdata.code == 1000) {
				...
				$.each(List_zcj,function(i,item){
					...
					str+='<div class="xinwen-kuang">\
                    <ul><li><img src="'+UPLOADS+'/'+item.title_img+'" width="190px" height="190px" /></li>\
                    <li><a href="'+ROOT+'/'+belong_url+'/'+item.id+'.html">'+item.title+'</a></li>\
                    <li>关键词：'+keyword+'</li>\
                    <li style="float: right;">发布日期:'+item.add_time+'</li>\
