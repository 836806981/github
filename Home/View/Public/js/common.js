...
(function ($) {
    ...
    ProductPageShow: function (obj,pagenum) {
        ...
        for (var i = 1; i < len + 1; i++) {
            if (i == 1) {
                str = '<a href="javascript:" class="yahei prev_page">上一个</a>\
                ...
                str = '<a href="javascript:" class="yahei pagenum">' + i + '</a>\
                          <a href="javascript:" class="yahei next_page">下一个</a>';
            } else {
                if (i > 5) {
                    classstr = 'pagehide';
                } else {
    ...
    CurrentPageShow: function (currentpage) {
        ...
        var spanstr = '<span class="yahei" style="width: 36px;height: 36px;display: inline-block;background: none;color: #666;">···</span>';
        for (var i = 0; i < len; i++) {
            if (len < 8) {
